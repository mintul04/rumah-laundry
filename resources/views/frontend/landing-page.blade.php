...
<body class="font-sans text-gray-800 bg-white antialiased overflow-x-hidden">
    <div x-data="{ mobileMenuOpen: false }">
        ...
        <nav x-data="{ scrolled: false }" x-init="window.addEventListener('scroll', () => scrolled = window.scrollY > 50)" :class="{ 'shadow-xl bg-white/95 backdrop-blur-md border-b border-gray-200/50': scrolled }"
            class="sticky top-0 z-50 w-full bg-white py-4 transition-all duration-300">
            <div class="container mx-auto px-4">
                <div class="flex items-center justify-between">
                    <!-- Brand with enhanced styling -->
                    <a href="#home" class="flex items-center gap-3 text-blue-600 font-extrabold text-lg no-underline group">
                        @if ($pengaturan->logo)
                            <div
                                ...
                                <img src="{{ Storage::url($pengaturan->logo) }}" alt="Logo" class="w-full h-full object-contain rounded">
                            </div>
                        @else
                            <div
                                class="w-10 h-10 rounded-lg shadow-lg flex items-center justify-center group-hover:shadow-xl transition-shadow bg-linear-to-br from-blue-600 via-cyan-500 to-emerald-500">
                    ...
                    <!-- Mobile Menu Button -->
                    <button @click="mobileMenuOpen = !mobileMenuOpen" class="lg:hidden text-gray-600 hover:text-blue-600 focus:outline-none transition-colors">
                    ...
                    <div class="hidden lg:flex items-center gap-1">
                        ...
                        <a href="#location" class="px-4 py-2 font-medium text-gray-600 hover:text-emerald-600 transition-colors">Lokasi</a>
                        <a href="#features" class="px-4 py-2 font-medium text-gray-600 hover:text-rose-600 transition-colors">Keunggulan</a>
                        <a href="#services" class="px-4 py-2 font-medium text-gray-600 hover:text-amber-600 transition-colors">Layanan</a>
                        <a href="#process" class="px-4 py-2 font-medium text-gray-600 hover:text-cyan-600 transition-colors">Cek Pesanan</a>
                        <a href="{{ route('login') }}"
                ...
                <!-- Mobile Menu -->
                <div x-show="mobileMenuOpen" @click.away="mobileMenuOpen = false" class="lg:hidden mt-4 py-4 px-4 bg-white rounded-2xl shadow-xl border border-gray-200" x-cloak>
                    <div class="flex flex-col gap-2">
                        <a href="#home" class="px-4 py-3 font-medium text-gray-600 hover:text-blue-600 hover:bg-blue-50 rounded-lg transition-colors">Beranda</a>
                        <a href="#location" class="px-4 py-3 font-medium text-gray-600 hover:text-emerald-600 hover:bg-emerald-50 rounded-lg transition-colors">Lokasi</a>
                        <a href="#features" class="px-4 py-3 font-medium text-gray-600 hover:text-rose-600 hover:bg-rose-50 rounded-lg transition-colors">Keunggulan</a>
                        <a href="#services" class="px-4 py-3 font-medium text-gray-600 hover:text-amber-600 hover:bg-amber-50 rounded-lg transition-colors">Layanan</a>
                        <a href="#process" class="px-4 py-3 font-medium text-gray-600 hover:text-cyan-600 hover:bg-cyan-50 rounded-lg transition-colors">Cek Pesanan</a>
                        <a href="{{ route('login') }}"
        ...
        <section id="home" class="relative py-24 md:py-20 bg-linear-to-br from-blue-50 via-white to-cyan-50 overflow-hidden">
                ...
                <div class="flex flex-col lg:flex-row items-center gap-12">
                    <div class="lg:w-1/2">
                        <h1 class="text-5xl md:text-6xl font-extrabold text-gray-900 leading-tight">
                            Cuci & Setrika <span class="bg-linear-to-r from-blue-600 via-cyan-500 to-emerald-500 bg-clip-text text-transparent">Semudah</span> Pesan Makanan
                        </h1>
                        ...
                        <div class="mt-12 flex flex-wrap gap-6">
                            <div class="bg-white p-6 rounded-2xl shadow-lg border border-gray-200/80 card-hover accent-badge hover:border-blue-300">
                            ...
                            <div class="bg-white p-6 rounded-2xl shadow-lg border border-gray-200/80 card-hover accent-badge hover:border-emerald-300">
                            ...
                            <div class="bg-white p-6 rounded-2xl shadow-lg border border-gray-200/80 card-hover accent-badge hover:border-rose-300">
                    ...
                    <div class="lg:w-1/2 flex justify-center">
                        <div class="bg-white rounded-3xl shadow-2xl p-10 card-hover relative">
                            <div class="absolute inset-0 bg-linear-to-br from-blue-50 to-cyan-50 rounded-3xl opacity-50"></div>
                            <!-- SVG Washing Machine with enhanced colors -->
                            <svg width="320" height="320" viewBox="0 0 300 300" fill="none" xmlns="http://www.w3.org/2000/svg" class="relative z-10">
                                <rect x="75" y="50" width="150" height="200" rx="12" fill="#F0F9FF" stroke="#0066FF" stroke-width="2.5" />
                                <rect x="90" y="70" width="120" height="30" rx="6" fill="#E0F2FE" stroke="#06B6D4" stroke-width="1.5" />
                                <circle cx="110" cy="85" r="5" fill="#0066FF" />
                                <circle cx="130" cy="85" r="5" fill="#06B6D4" />
                                <circle cx="150" cy="85" r="5" fill="#10B981" />
                                <circle cx="150" cy="150" r="50" fill="white" stroke="#0066FF" stroke-width="3.5" />
                                <circle cx="150" cy="150" r="35" fill="#E0F2FE" stroke="#06B6D4" stroke-width="2.5" />
                                <circle cx="150" cy="150" r="20" fill="white" stroke="#0066FF" stroke-width="2" />
                                <rect x="100" y="210" width="25" height="30" rx="4" fill="#10B981" opacity="0.9" stroke="#059669" stroke-width="1.5" />
                                <rect x="135" y="210" width="25" height="30" rx="4" fill="#F59E0B" opacity="0.9" stroke="#D97706" stroke-width="1.5" />
                                <rect x="170" y="210" width="25" height="30" rx="4" fill="#0066FF" opacity="0.9" stroke="#0052CC" stroke-width="1.5" />
                                ...
                                <path d="M150 40 L152 47 L159 49 L152 51 L150 58 L148 51 L141 49 L148 47 Z" fill="#F59E0B" opacity="0.8" />
                                <path d="M220 140 L222 145 L227 147 L222 149 L220 154 L218 149 L213 147 L218 145 Z" fill="#10B981" opacity="0.8" />
                            </svg>
                        </div>
                    </div>
                </div>
        ...
        <section id="location" class="py-24 bg-linear-to-b from-white to-gray-50">
            <div class="container mx-auto px-4">
                ...
                <div class="max-w-4xl mx-auto">
                    <div class="relative bg-white rounded-3xl p-10 border-2 border-gray-200/50 shadow-xl card-hover overflow-hidden">
                        <div class="absolute top-0 left-0 w-full h-1.5 bg-linear-to-r from-blue-600 via-cyan-500 to-emerald-500"></div>
                        ...
                        <div class="flex justify-center mb-8 relative z-10">
                            <div class="w-20 h-20 rounded-2xl shadow-xl flex items-center justify-center bg-linear-to-br from-blue-600 to-cyan-500">
                                <i class="fas fa-store text-white text-2xl"></i>
                            </div>
                        </div>
                        <h3 class="text-3xl font-bold text-center mb-4 text-gray-900">{{ $pengaturan->nama_laundry ?? 'RumahLaundry' }} Central</h3>
                        ...
                        <ul class="space-y-4 mb-10">
                            <li class="flex items-start gap-4 text-gray-700 group">
                                <div class="w-10 h-10 rounded-full bg-blue-100 flex items-center justify-center shrink-0 group-hover:bg-blue-600 group-hover:text-white transition-colors">
                                    <i class="fas fa-map-marker-alt text-blue-600 group-hover:text-white"></i>
                                </div>
                                <span class="pt-1">{{ $pengaturan->alamat_laundry }}</span>
                            </li>
                            <li class="flex items-start gap-4 text-gray-700 group">
                                <div class="w-10 h-10 rounded-full bg-emerald-100 flex items-center justify-center shrink-0 group-hover:bg-emerald-600 group-hover:text-white transition-colors">
                                    <i class="fas fa-clock text-emerald-600 group-hover:text-white"></i>
                                </div>
                                <span class="pt-1">Buka 24/7 jam, setiap hari</span>
                            </li>
                            <li class="flex items-start gap-4 text-gray-700 group">
                                <div class="w-10 h-10 rounded-full bg-rose-100 flex items-center justify-center shrink-0 group-hover:bg-rose-600 group-hover:text-white transition-colors">
                            ...
                            <li class="flex items-start gap-4 text-gray-700 group">
                                <div class="w-10 h-10 rounded-full bg-amber-100 flex items-center justify-center shrink-0 group-hover:bg-amber-600 group-hover:text-white transition-colors">
                            ...
                            <li class="flex items-start gap-4 text-gray-700 group">
                                <div class="w-10 h-10 rounded-full bg-cyan-100 flex items-center justify-center shrink-0 group-hover:bg-cyan-600 group-hover:text-white transition-colors">
            ...
            <div class="container mx-auto px-4">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
                    ...
                    @foreach ($features as $index => $f)
                        <div class="{{ $f['bgColor'] }} p-8 rounded-3xl border-2 border-gray-200/50 shadow-lg card-hover fade-in-up" style="animation-delay: {{ ($index + 1) * 0.1 }}s">
                            <div class="flex justify-center mb-6">
                                <div class="w-16 h-16 rounded-2xl bg-{{ $f['color'] }}-600 flex items-center justify-center shadow-lg">
        ...
        <section id="services" class="py-24 bg-linear-to-b from-white via-blue-50/20 to-white">
            <div class="container mx-auto px-4">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-20">
                    <!-- Cuci Biasa -->
                    <div class="bg-white p-8 rounded-3xl border-2 border-gray-200/50 shadow-lg card-hover fade-in-up" style="animation-delay: 0.1s;">
                        <div class="flex justify-center mb-6">
                        ...
                        <div class="w-full h-48 bg-linear-to-br from-blue-100 to-cyan-100 rounded-2xl mb-6 flex items-center justify-center">
                            <i class="fas fa-water text-blue-600 text-6xl opacity-20"></i>
                        </div>
                        <h3 class="text-2xl font-bold mb-3 text-gray-900">Cuci Biasa</h3>
                        <p class="text-gray-600 text-base mb-4">Cucian standar dengan deterjen berkualitas tinggi dan pewangi premium</p>
                        <div class="flex items-baseline gap-2 mb-3">
                            <span class="text-3xl font-bold text-blue-600">Rp 5K</span>
                            <span class="text-gray-600 text-sm">/Piece</span>
                        </div>
                        <p class="text-gray-500 text-sm flex items-center gap-2 bg-gray-50 px-3 py-2 rounded-lg">
                            <i class="far fa-clock text-amber-500"></i> 3-4 hari kerja
                        </p>
                    </div>

                    <!-- Cuci Express (Featured) -->
                    <div class="relative lg:col-span-1 md:col-span-2">
                        <div class="absolute inset-0 bg-linear-to-br from-amber-400 to-rose-400 rounded-3xl blur-xl opacity-30"></div>
                        <div class="relative bg-white p-8 rounded-3xl border-3 border-amber-400 shadow-2xl card-hover fade-in-up" style="animation-delay: 0.2s;">
                            <span class="absolute -top-4 right-6 bg-linear-to-r from-amber-500 to-rose-500 text-white text-xs font-bold px-4 py-2 rounded-full shadow-lg">⭐ Paling Populer</span>
                            <div class="flex justify-center mb-6 mt-2">
                                <div class="w-14 h-14 rounded-2xl bg-linear-to-br from-amber-500 to-rose-500 flex items-center justify-center shadow-lg">
                                    <i class="fas fa-star text-white text-xl"></i>
                                </div>
                            </div>
                            <div class="w-full h-48 bg-linear-to-br from-amber-100 to-rose-100 rounded-2xl mb-6 flex items-center justify-center">
                                <i class="fas fa-fire text-amber-600 text-6xl opacity-20"></i>
                            </div>
                            <h3 class="text-2xl font-bold mb-3 text-gray-900">Cuci Express</h3>
                            <p class="text-gray-600 text-base mb-4">Layanan kilat dalam 24 jam untuk kebutuhan mendesak Anda</p>
                            <div class="flex items-baseline gap-2 mb-3">
                                <span class="text-3xl font-bold text-amber-600">Rp 10K</span>
                                <span class="text-gray-600 text-sm">/Kg</span>
                            </div>
                            <p class="text-gray-500 text-sm flex items-center gap-2 bg-amber-50 px-3 py-2 rounded-lg">
                                <i class="fas fa-bolt text-amber-500"></i> Proses 1 hari kerja
                            </p>
                        </div>
                    </div>

                    <!-- Cuci + Setrika -->
                    <div class="bg-white p-8 rounded-3xl border-2 border-gray-200/50 shadow-lg card-hover fade-in-up" style="animation-delay: 0.3s;">
                        <div class="flex justify-center mb-6">
                            <div class="w-14 h-14 rounded-2xl bg-rose-600 flex items-center justify-center shadow-lg">
                                <i class="fas fa-tshirt text-white text-xl"></i>
                            </div>
                        </div>
                        <div class="w-full h-48 bg-linear-to-br from-rose-100 to-pink-100 rounded-2xl mb-6 flex items-center justify-center">
                            <i class="fas fa-tshirt text-rose-600 text-6xl opacity-20"></i>
                        </div>
                        <h3 class="text-2xl font-bold mb-3 text-gray-900">Cuci + Setrika</h3>
                        <p class="text-gray-600 text-base mb-4">Paket lengkap dengan setrika profesional dan lipatan sempurna</p>
                        <div class="flex items-baseline gap-2 mb-3">
                            <span class="text-3xl font-bold text-rose-600">Rp 8K</span>
                            <span class="text-gray-600 text-sm">/Lusin</span>
                        </div>
                        <p class="text-gray-500 text-sm flex items-center gap-2 bg-gray-50 px-3 py-2 rounded-lg">
                            <i class="far fa-clock text-rose-500"></i> 2-3 hari kerja
                        </p>
                    </div>
                </div>

                <!-- More Services CTA -->
                <div class="text-center bg-linear-to-r from-blue-50 to-cyan-50 rounded-3xl p-12 border-2 border-blue-200/50">
                    <h2 class="text-3xl md:text-4xl font-extrabold text-gray-900 mb-4">Dan Masih Banyak Lainnya</h2>
                    <p class="text-lg text-gray-600 mb-8">Berbagai paket laundry spesial sesuai kebutuhan dan budget Anda</p>
                    <a href="#location"
        ...
        <section id="process" class="py-24 bg-linear-to-br from-blue-600 via-cyan-600 to-emerald-600 text-white relative overflow-hidden">
            ...
            <div class="container mx-auto px-4 relative z-10">
                ...
                <div class="max-w-lg mx-auto">
                    <form id="statusForm" class="bg-white/95 rounded-2xl shadow-2xl overflow-hidden mb-10 backdrop-blur-sm">
                        @csrf
                        <div class="flex flex-col sm:flex-row gap-0">
                            <input type="text" id="orderCode" placeholder="Masukkan nomor order (ORD-000001)" class="flex-1 px-6 py-4 text-gray-800 focus:outline-none text-base sm:text-lg">
                            <button type="submit"
                    ...
                    <div id="statusResult" class="hidden bg-white/95 text-gray-800 rounded-2xl shadow-2xl p-8 mb-12 backdrop-blur-sm">
                        <h5 class="text-xl font-bold mb-4">Status Pesanan: <span id="statusText" class="text-emerald-600"></span></h5>
                    ...
                    <div class="flex flex-col sm:flex-row items-center justify-between gap-6 sm:gap-0">
                        ...
                        @foreach ($steps as $i => $step)
                            <div id="step-{{ $i }}" class="text-center flex flex-col items-center">
                                <div class="w-20 h-20 rounded-full bg-white/20 border-3 border-white/40 flex items-center justify-center mb-3 text-2xl shadow-lg transition-all duration-500">
                                    <i class="fas {{ $step['icon'] }}"></i>
                                </div>
                                <div class="text-sm font-semibold opacity-90">{{ $step['label'] }}</div>
                            </div>
                            @if (!$loop->last)
                                <div id="connector-{{ $i }}" class="h-1.5 w-12 sm:w-16 bg-white/20 rounded-full relative hidden sm:block" style="margin: 0;">
                                    <div class="absolute top-0 left-0 h-full bg-white rounded-full shadow-lg" style="width: 0%; transition: width 0.8s cubic-bezier(0.34, 1.56, 0.64, 1);"></div>
                                </div>
                            @endif
                        @endforeach
                    </div>
        ...
        <footer id="footer" class="bg-gray-900 text-gray-300 pt-20 pb-10 relative">
            <div class="absolute top-0 left-0 right-0 h-1 bg-linear-to-r from-blue-600 via-cyan-500 to-emerald-500"></div>
            <div class="container mx-auto px-4">
                <div class="grid grid-cols-1 md:grid-cols-3 gap-10 mb-12">
                    <div>
                        <div class="flex items-center gap-2 mb-4">
                            ...
                            <h5 class="text-white text-xl font-bold">{{ $pengaturan->nama_laundry ?? 'RumahLaundry' }}</h5>
                        </div>
                        <p class="text-sm text-gray-400 mb-6 leading-relaxed">
                            Layanan laundry terpercaya dengan standar kebersihan tinggi dan pelayanan maksimal untuk keluarga Anda.
                        </p>
                        <div class="flex gap-3">
                            <a href="#" class="w-11 h-11 rounded-full bg-gray-800 flex items-center justify-center hover:bg-blue-600 transition-all shadow-lg hover:shadow-xl">
                                <i class="fab fa-facebook-f"></i>
                            </a>
                            <a href="#" class="w-11 h-11 rounded-full bg-gray-800 flex items-center justify-center hover:bg-pink-600 transition-all shadow-lg hover:shadow-xl">
                                <i class="fab fa-instagram"></i>
                            </a>
                            <a href="#" class="w-11 h-11 rounded-full bg-gray-800 flex items-center justify-center hover:bg-emerald-600 transition-all shadow-lg hover:shadow-xl">
                                <i class="fab fa-whatsapp"></i>
                            </a>
                            <a href="#" class="w-11 h-11 rounded-full bg-gray-800 flex items-center justify-center hover:bg-rose-600 transition-all shadow-lg hover:shadow-xl">
                    ...
                    <div>
                        ...
                        <ul class="space-y-3">
                            <li><a href="#services" class="hover:text-blue-400 transition-colors text-gray-400">Cuci Biasa</a></li>
                            <li><a href="#services" class="hover:text-emerald-400 transition-colors text-gray-400">Cuci + Setrika</a></li>
                            <li><a href="#services" class="hover:text-amber-400 transition-colors text-gray-400">Express 24 Jam</a></li>
                            <li><a href="#services" class="hover:text-rose-400 transition-colors text-gray-400">Layanan Khusus</a></li>
                        </ul>
                    </div>
                    <div>
    ...
    <script>
        ...
        document.getElementById('statusForm').addEventListener('submit', async function(e) {
            ...
            btn.innerHTML = '<span class="inline-block w-4 h-4 border-2 border-emerald-600 border-t-transparent rounded-full animate-spin me-2"></span>Memproses...';
            btn.disabled = true;
