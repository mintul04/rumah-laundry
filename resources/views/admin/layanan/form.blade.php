        ...
        <form action="{{ route('layanan.store') }}" method="POST">
            ...
            <div class="form-group">
                ...
                <select name="tipe" class="form-control" required>
                    ...
                    <option value="express" @if (old('tipe') === 'express') selected @endif>Express (1 Hari)</option>
                    <option value="regular" @if (old('tipe') === 'regular') selected @endif>Regular (3 Hari)</option>
                    <option value="economy" @if (old('tipe') === 'economy') selected @endif>Economy (5 Hari)</option>
                </select>
            </div>
            ...
            <div class="form-group">
                ...
                <textarea name="deskripsi" class="form-control" placeholder="Jelaskan detail layanan ini..." required>{{ old('deskripsi') }}</textarea>
            </div>
