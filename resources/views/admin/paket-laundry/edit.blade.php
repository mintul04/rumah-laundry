...
@section('title', 'Edit Paket Laundry - RumahLaundry')
@section('page-title', 'Edit Paket Laundry')

@section('content')
    <div x-data="{
        hargaDisplay: @js(old('harga', $paketLaundry->harga) ? number_format((int) old('harga', $paketLaundry->harga), 0, ',', '.') : ''),
        hargaRaw: @js(old('harga', $paketLaundry->harga)),
        formatHarga() {
            if (this.hargaRaw) {
        ...
        <div class="bg-white rounded-xl shadow-lg border border-gray-200 overflow-hidden">
            ...
            <div class="p-6">
                <div class="bg-blue-50 border-l-4 border-blue-500 p-4 rounded mb-6 text-blue-800">
                    ...
                    Edit informasi paket laundry di bawah ini. Pastikan data yang diubah sudah benar.
                </div>
                ...
                <form action="{{ route('paket-laundry.update', $paketLaundry->id) }}" method="POST">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="nama_paket" value="{{ old('nama_paket', $paketLaundry->nama_paket) }}" required
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                        ...
                        <div>
                            ...
                            <select name="waktu_pengerjaan" required
                                ...
                                <option value="6-12 jam" {{ old('waktu_pengerjaan', $paketLaundry->waktu_pengerjaan) == '6-12 jam' ? 'selected' : '' }}>6-12 Jam</option>
                                <option value="2-3 hari" {{ old('waktu_pengerjaan', $paketLaundry->waktu_pengerjaan) == '2-3 hari' ? 'selected' : '' }}>2-3 Hari</option>
                                <option value="1-2 hari" {{ old('waktu_pengerjaan', $paketLaundry->waktu_pengerjaan) == '1-2 hari' ? 'selected' : '' }}>1-2 Hari</option>
                    ...
                    <div class="mb-8">
                        ...
                        <textarea name="deskripsi" rows="4" required class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition"
                            placeholder="Masukkan deskripsi paket laundry">{{ old('deskripsi', $paketLaundry->deskripsi) }}</textarea>
