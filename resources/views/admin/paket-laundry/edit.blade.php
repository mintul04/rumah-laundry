                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select name="satuan" class="form-control" required>
                                            ...
                                            <option value="kg" {{ old('satuan', $paketLaundry->satuan) == 'kg' ? 'selected' : '' }}>
                                                Kg - Kilogram
                                            </option>
                                            <option value="pcs" {{ old('satuan', $paketLaundry->satuan) == 'pcs' ? 'selected' : '' }}>
                                                Pcs - Piece (Per Potong)
                                            </option>
                                            <option value="lusin" {{ old('satuan', $paketLaundry->satuan) == 'lusin' ? 'selected' : '' }}>
                                                Lusin
                                            </option>
                                        </select>
                                        @error('satuan')
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select name="waktu_pengerjaan" class="form-control" required>
                                            ...
                                            <option value="express" {{ old('waktu_pengerjaan', $paketLaundry->waktu_pengerjaan) == 'express' ? 'selected' : '' }}>
                                                Express (24 Jam)
                                            </option>
                                            <option value="regular" {{ old('waktu_pengerjaan', $paketLaundry->waktu_pengerjaan) == 'regular' ? 'selected' : '' }}>
                                                Regular (2-3 Hari)
                                            </option>
                                            <option value="ekonomi" {{ old('waktu_pengerjaan', $paketLaundry->waktu_pengerjaan) == 'ekonomi' ? 'selected' : '' }}>
                                                Ekonomi (4-5 Hari)
                                            </option>
                                        </select>
