                ...
                @forelse ($transaksis as $item)
                    <tr>
                        ...
                        <td>
                            ...
                            @else
                                <span class="badge-status bg-danger text-white">Belum Lunas</span>
                            @endif
                        </td>

                        <td>
                            @if ($item->status_order == 'baru')
                                <span class="badge-status bg-primary text-white">Baru</span>
                            @elseif ($item->status_order == 'diproses')
                                <span class="badge-status bg-info text-dark">Diproses</span>
                            @elseif ($item->status_order == 'selesai')
                                <span class="badge-status bg-success text-white">Selesai</span>
                            @else
                                <span class="badge-status bg-secondary text-white">Diambil</span>
                            @endif
                        </td>
