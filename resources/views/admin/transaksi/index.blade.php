                            ...
                            @foreach ($transaksis as $item)
                                <tr x-show="(@js($item->no_order . ' ' . $item->pelanggan?->nama ?? '-')).toLowerCase().includes(searchTerm.toLowerCase())"
                                    ...
                                    <td class="px-6 py-4">
                                        ...
                                        @elseif ($item->status_order == 'kadaluarsa')
                                            <span
                                                class="inline-flex items-center gap-1 px-2.5 py-0.5 rounded-full text-xs font-medium bg-red-100 text-red-800">Kadaluarsa</span>
                                        @else
                                            <span
